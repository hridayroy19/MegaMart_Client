...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-[#0b0f18] text-slate-200 font-sans">
      ...
      <div className="lg:ml-72 min-h-screen flex flex-col">
        {/* Top Navbar */}
        <header className="sticky top-0 z-30 bg-[#0b0f18]/80 backdrop-blur-md border-b border-slate-800/60 px-4 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex items-center gap-3 px-4 py-2 bg-slate-900/50 border border-slate-800/60 rounded-xl w-64 lg:w-96">
            ...
            <div className="flex items-center gap-4 lg:gap-6">
              ...
              <div className="flex items-center gap-3 pl-4 border-l border-slate-800/60">
                <div className="hidden sm:block text-right">
                  ...
                  <p className="text-[10px] text-slate-500 font-medium uppercase tracking-wider">{user?.role || "Customer"}</p>
                </div>
